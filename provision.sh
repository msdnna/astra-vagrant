...
wget --no-check-certificate -qOauthorized_keys https://raw.githubusercontent.com/mitchellh/vagrant/master/keys/vagrant.pub
...
wget --no-check-certificate -qO- https://raw.githubusercontent.com/vmware/cloud-init-vmware-guestinfo/$GIT_REF/install.sh \
    | bash -x -
unset GIT_REF
...
#       sudo virt-filesystems -a ~/.vagrant.d/boxes/astra-1.6-amd64/0/libvirt/box.img
#       sudo mkdir /mnt/astra-1.6-amd64
#       sudo guestmount -a ~/.vagrant.d/boxes/astra-1.6-amd64/0/libvirt/box.img -m /dev/sda1 --pid-file guestmount.pid --ro /mnt/astra-1.6-amd64
#       sudo bash -c 'unmkinitramfs /mnt/astra-1.6-amd64/boot/initrd.img /tmp/astra-1.6-amd64-initrd' # NB prefer unmkinitramfs over cpio.
#       sudo ls -laF /mnt/var/lib/systemd
#       sudo guestunmount /mnt/astra-1.6-amd64
...
# see https://manpages.astra.com/manpages/bionic/man4/random.4.html
# see https://manpages.astra.com/manpages/bionic/man7/random.7.html
...
apt-get update
apt-get remove -y --purge debian-archive-keyring
