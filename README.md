This builds an up-to-date Vagrant Astra Linux Base Box as described at the [From Iso To Vagrant Box](http://blog.ruilopes.com/from-iso-to-vagrant-box.html) article.
...
On a Astra Linux host, install the dependencies by running the file at:
...
export VSPHERE_OS_ISO="[$GOVC_DATASTORE] iso/smolensk-1.6.iso"
export VSPHERE_ESXI_HOST='esxi.local'
export VSPHERE_TEMPLATE_FOLDER='test/templates'
export VSPHERE_TEMPLATE_NAME="$VSPHERE_TEMPLATE_FOLDER/astra-1.6-amd64-vsphere"
export VSPHERE_VM_FOLDER='test'
export VSPHERE_VM_NAME='astra-vagrant-example'
...
Download the Astra Linux ISO (you can find the full iso URL in the [astra.pkr.hcl](astra.pkr.hcl) file) and place it inside the datastore as defined by the `iso_paths` property that is inside the [packer template](astra-vsphere.pkr.hcl) file.
